...
def primary_secondary_options(cargos, trucks):
  ...
  for cargo_name, cargo_info in cargos.items():
    ...
    for truck_name, truck_info in trucks.items():
      ...
      truck_to_origin_distance = calculate_distance(truck_info['lng'], truck_info['lat'], cargo_info['o_lng'], cargo_info['o_lat'])
      truck_to_end_distance = calculate_distance(truck_info['lng'], truck_info['lat'], cargo_info['d_lng'], cargo_info['d_lat'])
